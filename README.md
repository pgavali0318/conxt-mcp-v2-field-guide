...
**Guide version:** 1.0 · **Published:** August 2026
...
The technical specifics in this guide were reviewed against the official MCP Python SDK v2 migration guide and API reference. Items marked ✓ in the "what changed" table are documented in those official sources.
...
The guide text, PDF, HTML, and README are released under **[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)** — free to share and adapt with attribution. Code snippets are separately available under the **MIT License**. See [LICENSE](./LICENSE) for details.
